...
export default function UploadPage() {
  return (
    <div className="min-h-[calc(100vh-4.5rem)] flex flex-col items-center">
      <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-24 flex flex-col items-center w-full max-w-[1100px]">
        <div className="text-center mb-16 max-w-3xl">
          <h1 className="text-[40px] font-serif font-bold tracking-tight text-primary mb-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="rounded-2xl border border-border bg-card p-8 flex flex-col shadow-sm">
              <h3 className="text-primary font-bold text-[13px] tracking-wider uppercase mb-7">Tiêu chuẩn tệp</h3>
            ...
            {/* Support Card */}
            <div className="bg-primary/20 rounded-2xl shadow-sm border border-primary/20 overflow-hidden relative flex-1 min-h-[180px] flex flex-col justify-end p-6">
              {/* Image Overlay */}
              <div 
              ...
              <div className="relative z-20">
                ...
                <p className="text-primary font-medium text-[13px] leading-relaxed pr-4">Xem hướng dẫn định dạng tài liệu chuẩn IEEE/APA</p>
              </div>
            </div>
          </div>
        </div>
