...
export default function RegisterPage() {
  return (
    <div className="container relative mx-auto flex-col items-center justify-center flex min-h-[80vh] px-4">
      <Link
        href="/"
        ...
        <Card className="border-0 shadow-xl bg-card/50 backdrop-blur-sm ring-1 ring-primary/10">
          ...
          <CardContent className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Input id="name" type="text" placeholder="Nguyễn Văn A" className="bg-background/50 focus:bg-background transition-colors" />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="email">Email</Label>
              <Input id="email" type="email" placeholder="m@example.com" className="bg-background/50 focus:bg-background transition-colors" />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="password">Mật khẩu</Label>
              <Input id="password" type="password" placeholder="••••••••" className="bg-background/50 focus:bg-background transition-colors" />
            </div>
          </CardContent>
